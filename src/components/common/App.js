...
import Materialrequirements from '../app/materialManage/Materialrequirements.js';//mes
 //设备管理
import DeviceRequirements from '../app/deviceManage/DeviceRequirements.js'; //mes
import DeviceHealth from '../app/deviceManage/DeviceHealth.js';//mes
import DeviceManagement from '../app/deviceManage/DeviceManagement.js';//mes
//任务中心
import SubReport from '../app/missions/SubReport.js';//mes
import MaterialReq from '../app/missions/MaterialReq.js';//mes
import DeviceProblem from '../app/missions/DeviceProblem.js';//mes
import Mission from '../app/missions/Mission.js';//mes
//机器人服务（用户端） 
...
// 销售订单
import saleOrderManage from '../app/saleOrder/slaeOrderManage/index'
// 生产订单
import peoductOrderManage from '../app/MES/productOrder/productOrderManage/index'
			        ...
			        <Layout style={{ padding:0, marginTop: '3rem' }}>
			          ...
			          >
			            <Switch>
			 							{/* 主页 */}
											{/* 
											 <Route component={ProgressTrack}/> 
											 //path为空，相当于path是"/app/"，访问到app就停止匹配了
										...
										{/* 设备管理 */}
										<Route exact path="/app/deviceManage/DeviceRequirements/" component={DeviceRequirements}/>	
										<Route exact path="/app/deviceManage/DeviceHealth/" component={DeviceHealth}/>
										<Route exact path="/app/deviceManage/DeviceManagement/" component={DeviceManagement}/>
											{/* 任务中心 */}
										<Route exact path="/app/missions/Mission/" component={Mission}/>
										<Route exact path="/app/missions/SubReport/" component={SubReport}/>	
										<Route exact path="/app/missions/MaterialReq/" component={MaterialReq}/>
										<Route exact path="/app/missions/DeviceProblem/" component={DeviceProblem}/>
										...
										{/* 销售订单 */}
										<Route exact path="/app/slaeOrderManage" component={saleOrderManage}/>
										{/* MES */}
										<Route exact path="/app/productOrderManage" component={peoductOrderManage}/>

...
import { originalUrl, materialinout, } from '../../../dataModule/UrlList';
...
class Materialinout extends Component{
	constructor() {
	    super();
			this.state = {
				...
				data: [],
				columns:[
					{title: '物料名',dataIndex: 'material_name',width: '9%',align:'center',},
					{title: '物料号',dataIndex: 'material_num',width: '9%',align:'center',},
					{title: '物料类型',dataIndex: 'material_type',width: '9%',align:'center',},
					{title: '材料',dataIndex: 'material_science',width: '9%',align:'center',},
					{title: '数量',dataIndex: 'quantity',width: '9%',align:'center',},
					{title: '出/入库',dataIndex: 'out_in',width: '9%',align:'center',},
					{title: '操作人',dataIndex: 'operator',width: '9%',align:'center',},
					{title: '操作时间',dataIndex: 'operation_time',width: '9%',align:'center',},
					{title: '订单序号',dataIndex: 'order_number',width: '9%',align:'center',},
					{title: '库位',dataIndex: 'location',width: '9%',align:'center',},
							...
							<table className="table">
								...
								<tbody>
									...
									<tr>
										...
										<td>
											<Input className="select" value={ModalForm.material_science} onChange={(ev)=>{this.Modal2Change(ev,"material_science")}}/>
										</td>
									</tr>
									<tr>
	...
	init = ()=>{
		const me = this;
		let params = {};
		let url = originalUrl + materialinout;
	...
	//删除出入库信息
	handleDelete = (id)=>{
		let url = originalUrl + materialinout + id + '/';
		let params = {};

	    ...
	    super();
			this.state = {
				...
				columns:[
					...
					{title: '角色',dataIndex: 'role',width: '8%',align:'center',},
					...
					// {title: '权限',dataIndex: 'type',width: '5%',align:'center',},
							...
							<table className="table">
								...
								<tbody>
									...
									<tr>
										...
										<td><Input style={{width: '100%',height: '100%'}} value={ModalForm.type} onChange={(ev)=>{this.Modal1Change(ev,'type')}}/></td>
									</tr>
									<tr>
